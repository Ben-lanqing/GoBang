...
namespace GoBangCL.Standard
{
    public class GoBangCL
    {
        ...
        /// <returns></returns>
        private static PieceInfo GetBest(List<PieceInfo> List)
        {
            if (List.Count == 1)
                return List[0];
         ...
         * @return
         */
        private static Boolean IsDefendCrossPoint(PieceInfo tmpCrossPointN, int player, int index)
        {
         ...
         * @return
         */
        private static int GetNuOfFlag(StateEnum flag)
        {
            int returnNu = 0;
            //if (flag == "D")
            //    returnNu = 5;
